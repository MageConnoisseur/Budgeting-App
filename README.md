...
Full-stack personal budgeting app (desktop web first) for monthly income, expenses, and savings planning, transaction tracking, and analysis. A thin Expo client in `mobile/` shows leftover and logs income, expenses, and savings on the go against the same API.
...
/
  ...
  mobile/       # Android leftover glance + logger (sideload APK; same API as web)
```
